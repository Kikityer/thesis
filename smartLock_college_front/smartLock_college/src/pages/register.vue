<template>
  <div class="bgImg">
    <Card class="p-register">
      <p slot="title" style="text-align: center; font-size: 16px">宿管账号注册</p>
      <Form
        ref="formValidate"
        :model="formValidate"
        :rules="ruleValidate"
        ...
        <Form-item label="职工工号" prop="jobNum">
          <Input
            v-model="formValidate.jobNum"
            size="large"
            placeholder="请输入宿管员工工号"
    ...
    <p style="text-align: center;  font-size: 14px; position: absolute; top: 90%;left: 44%;color: white" >Copyright &copy; 2018-2019 Kikityer</p>
  </div>
